...
export default function Login({saveuserdata}) {
  ...
  async function sendData (){
    let {data} = await axios.post(`http://localhost:2500/user/login` , datas)
    console.log(data);
  ...
  <form onSubmit={startApi}>
    ...
    <label htmlFor="email" className='ms-3 pb-2'> email</label>
    ...
    <label htmlFor="password" className='ms-3 pb-2'> password</label>
